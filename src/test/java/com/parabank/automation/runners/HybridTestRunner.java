...
@CucumberOptions(features = "src/test/resources/features/hybrid", glue = {
		"com.parabank.automation.stepdefinitions.hybrid", "com.parabank.automation.hooks" }, plugin = { "pretty",
				"summary", "json:" + FrameworkConstants.CUCUMBER_JSON_REPORT_FILE,
				"junit:" + FrameworkConstants.CUCUMBER_JUNIT_REPORT_FILE,
				"html:" + FrameworkConstants.CUCUMBER_HTML_REPORT_FILE }, tags = "@hybrid and not @manual", monochrome = true, publish = false)
